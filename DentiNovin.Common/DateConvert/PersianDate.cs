        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            switch(format)
            {
                case "D":
                    ...
                    return string.Format("{0} {1} {2} {3}", new object[4] { LocalizedWeekDayName, Utilities.toDouble(Day), LocalizedMonthName, Year });
                    
                case "f":
                    //'hh:mm yyyy mmmm dd dddd' e.g. 'دوشنبه 20 شهریور 1384 21:30'
                    return string.Format("{0} {1} {2} {3} {4}:{5}", new object[6] { LocalizedWeekDayName, Utilities.toDouble(Day), LocalizedMonthName, Year, Utilities.toDouble(Hour), Utilities.toDouble(Minute) });

                case "F":
                    //'tt hh:mm:ss yyyy mmmm dd dddd' e.g. 'دوشنبه 20 شهریور 1384 02:30:22 ب.ض'
                    return string.Format("{0} {1} {2} {3} {4}:{5}:{6} {7}", new object[8] { LocalizedWeekDayName, Utilities.toDouble(Day), LocalizedMonthName, Year, Utilities.toDouble(smallhour), Utilities.toDouble(Minute), Utilities.toDouble(Second), designator });
                    
                case "g":
                    //'yyyy/mm/dd hh:mm tt'
                    return string.Format("{0}/{1}/{2} {3}:{4} {5}", new object[6] { Year, Utilities.toDouble(Month), Utilities.toDouble(Day), Utilities.toDouble(smallhour), Utilities.toDouble(Minute), designator });
                    
                case "G":
                    //'yyyy/mm/dd hh:mm:ss tt'
                    return string.Format("{0}/{1}/{2} {3}:{4}:{5} {6}", new object[7] { Year, Utilities.toDouble(Month), Utilities.toDouble(Day), Utilities.toDouble(smallhour), Utilities.toDouble(Minute), Utilities.toDouble(Second), designator });
                ...
                case "s":
                    //'yyyy-mm-ddThh:mm:ss'
                    return string.Format("{0}-{1}-{2}T{3}:{4}:{5}", Year, Utilities.toDouble(Month), Utilities.toDouble(Day), Utilities.toDouble(Hour), Utilities.toDouble(Minute), Utilities.toDouble(Second));
                    
                case "t":
                    //'hh:mm tt'
                    return string.Format("{0}:{1} {2}", Utilities.toDouble(smallhour), Utilities.toDouble(Minute), designator);
                    
                case "T":
                    //'hh:mm:ss tt'
                    return string.Format("{0}:{1}:{2} {3}", new object[4] { Utilities.toDouble(smallhour), Utilities.toDouble(Minute), Utilities.toDouble(Second), designator });

                case "md":
                    //'mm/dd' e.g. '9/1'
                    return string.Format("{0}/{1}", Utilities.toDouble(Month), Utilities.toDouble(Day));

                case "d":
                default:
                    //ShortDatePattern yyyy/mm/dd e.g. '1384/9/1'
                    return string.Format("{0}/{1}/{2}", Year, Utilities.toDouble(Month), Utilities.toDouble(Day));
