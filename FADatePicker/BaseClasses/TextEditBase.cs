...
namespace FADatePicker.BaseClasses
{
    ...
    public class TextEditBase : BaseControl
    {
        ...
        public TextEditBase()
        {
            ...
            TextBox.MouseUp += new MouseEventHandler(InvokeMouseUp);
            TextBox.MouseDown += new MouseEventHandler(InvokeMouseDown);
            TextBox.MouseEnter += new EventHandler(InvokeMouseEnter);
            TextBox.MouseHover += new EventHandler(InvokeMouseHover);
            TextBox.MouseLeave += new EventHandler(InvokeMouseLeave);
            TextBox.MouseMove += new MouseEventHandler(InvokeMouseMove);
            TextBox.KeyDown += new KeyEventHandler(InvokeKeyDown);
            TextBox.KeyPress += new KeyPressEventHandler(InvokeKeyPress);
            TextBox.KeyUp += new KeyEventHandler(InvokeKeyUp);
            TextBox.Click += new EventHandler(InvokeClick);
            TextBox.DoubleClick += new EventHandler(InvokeDoubleClick);

            ThemeChanged += new EventHandler(OnThemeChanged);
