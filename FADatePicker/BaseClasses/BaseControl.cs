    ...
    public abstract class BaseControl : BaseStyledControl, INotifyPropertyChanged
    {
        ...
        public bool HasErrors
        {
            ...
            set
            {
                ...
                {
                    Error.SetError(this, FALocalizeManager.GetLocalizerByCulture(System.Threading.Thread.CurrentThread.CurrentUICulture).GetLocalizedString(StringID.Validation_NotValid));
                }
            }
        }
        ...
        protected virtual StringFormat TextFormat
        {
            get
            {
                StringFormat fmt = (StringFormat)StringFormat.GenericDefault.Clone();
