...
namespace FADatePicker
{
    public class FAContainerComboBox : DateEditBase
    {
        ...
        private bool isButtonHot = false;
        ...
        public FAContainerComboBox()
        {
            ...
            LostFocus += new EventHandler(OnInternalLostFocus);
            TextBox.RightToLeft = RightToLeft;
            TextBox.Font = Font;
            TextBox.MouseMove += new MouseEventHandler(OnDropDownMouseMove);
            TextBox.KeyDown += new KeyEventHandler(OnDropDownKeyDown);
        }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (IsMouseOverButton() && isButtonPressed)
            {
                ShowDropDown();
                RaiseButtonClick();
            }
