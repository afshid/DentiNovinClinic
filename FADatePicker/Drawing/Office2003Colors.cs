...
namespace FADatePicker.Drawing
{
    ...
    internal class Office2003Colors
    {
        ...
        private static Office2003Colors defaultColors;
        private static int[][] Office11Colors = new int[][] 
        {  
		    new int[] {0xddecfe, 0x81a9e2, 0x9ebef5, 0xc3daf9, 0x3b619c, 0x274176, 0xFFFFFF, 0x6a8ccb, 0xf1f9ff,
                       0x000080, 0xFFF6CF, 0xffd091, 0xfe8e4b, 0xffd28e, 0x000000, 0x8D8D8D, 0x75a6f1, 0x053995, 
                       0xF6F6F6, 0x002d96, 0x2a66c9, 0xc4dbf9, 0xbedafb, 0x7ba2e7, 0x6375d6, 0xd6dff7, 0x215dc6,
            ...
            new int[] {0xf4f7de, 0xb7c691, 0xd9d9a7, 0xf2f0e4, 0x608058, 0x515e33, 0xFFFFFF, 0x608058, 0xf4f7de,
                       0x3f5d38, 0xFFF6CF, 0xffd091, 0xfe8e4b, 0xffd28e, 0x000000, 0x8D8D8D, 0xb0c28c, 0x60776b,
                       0xF4F4F4, 0x758d5e, 0x74865e, 0xe1dead, 0xafba91, 0xccd9ad, 0xa5bd84, 0xf6f6ec, 0x56662d,
            ...
            new int[] {0xf3f4fa, 0x9997b5, 0xd7d7e5, 0xf3f3f7, 0x7c7c94, 0x545475, 0xFFFFFF, 0x6e6d8f, 0xFFFFFF,
                       0x000080, 0xFFF6CF, 0xffd091, 0xfe8e4b, 0xffd28e, 0x000000, 0x8D8D8D, 0xb3b2c8, 0x767492, 
                       0xfdfaff, 0x7c7c94, 0x7a7999, 0xdbdae4, 0xe5e5eb, 0xc4c8d4, 0xb1b3c8, 0xf0f1f5, 0x3f3d3d,
        ...
        public void InitOfficeColors(int id)
        {
        ...
        public static XPThemeType GetThemeType()
        {
            ...
            else if (themeName == "HOMESTEAD")
            {
                return XPThemeType.Homestead;
            }
            else if (themeName == "METALLIC")
            {
        ...
        public static int GetDarkValue(int val)
        {
            return (val * 8) / 10;
        }

        public static int GetLightValue(byte val)
        {
        ...
        {
            return Color.FromArgb((int)(rgb + (uint)0xff000000));
        }
