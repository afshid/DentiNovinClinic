...
{
    public class DateTimeCollection : System.Collections.Generic.ICollection<DateTime>, IList<DateTime>
    {
        ...
        private List<DateTime> data = new List<DateTime>();
        ...
        {
            return data.GetEnumerator() as IEnumerator<DateTime>;
        }
