...
using DentiNovin.Controls.Popup.Win32;
   ...
   public  class TopFormBase: Form
    {
        ...
        private int shadowSize = Shadow.DefaultShadowSize;
        ...
        protected void UpdateShadows()
        {
            ...
            if (visible)
            {
                ...
                Shadow.CreateShadows(Shadows, Shadow.DefaultShadowSize, true, this, r);
            }
            else
                Shadow.HideShadows(Shadows);
        }
